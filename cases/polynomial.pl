...
'https://eyereasoner.github.io/euler#roots'(P, L) :-
...
solutionLagrange(P, Q, R, Z) :-
    ...
    est(D, moins(carre(Q))),
    'https://eyereasoner.github.io/euler#roots'([A, B, C, D], [Y1, Y2, Y3]),
    est(Y1p, racine(2, Y1)),
    est(Y2p, racine(2, Y2)),
    est(Y3p, racine(2, Y3)),
...
% query
query('https://eyereasoner.github.io/euler#roots'([[1, 0], [-10, 0], [35, 0], [-50, 0], [24, 0]], _ANSWER)).
query('https://eyereasoner.github.io/euler#roots'([[1, 0], [-9, -5], [14, 33], [24, -44], [-26, 0]], _ANSWER)).
