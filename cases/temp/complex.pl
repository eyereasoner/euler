...
'https://eyereasoner.github.io/euler#atan'(A, B) :-
    ...
    add([[0, 1], A], D),
    divide([C, D], E),
    'https://eyereasoner.github.io/euler#log'([e, 0], E, F),
    divide([F, [0, 2]], B).
...
query('https://eyereasoner.github.io/euler#exp'([e, 0], [0, pi], _ANSWER)).
query('https://eyereasoner.github.io/euler#log'([e, 0], [-1, 0], _ANSWER)).
